...
const LeadsContainer = ({ leads = [], updateLeadNotes, updateLeadStatus, deleteLead, moveLeadToBucket, buckets, currentBucketId, onEditingStart, currentIndex, setCurrentIndex }) => {
